        ...
        <div class="row justify-content-center">
            <div class="col-lg-7">
                ...
                @else
                    ...
                    <a href="/items" class="btn btn-dark">Continue Shopping</a>
                @endif

                @foreach($cartCollection as $item)
                    <div class="row">
                        <div class="col-lg-3">
                            <img src="https://darkgrambucket.s3.us-east-2.amazonaws.com/coverImages{{$item->attributes->img}}" class="img-thumbnail" width="200" height="200">
                        </div>
                        <div class="col-lg-5">
                            <p>
